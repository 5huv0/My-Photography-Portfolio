        ...
        <div>
            <div className="container main-event-sec">
                <div className="container text-start">
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <img src="./images/shoumick.jpg" alt="" className="event-main-img"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="main-event-sec">
                <div className="container text-start">
                    <div className="row">
                        <div className="col">
                            <img src="./images/shihab.jpg" alt="" className="event-main-img"/>
                        </div>
                        <div className="col">
                            <p className="event-main-head">
                                The Imanination
            ...
            <div className="main-event-sec">
                <div className="container text-start">
                    <div className="row">
                        ...
                        <div className="col">
                            <img src="./images/saju.jpg" alt="" className="event-main-img"/>
                        </div>
                    </div>
                </div>
            </div>
