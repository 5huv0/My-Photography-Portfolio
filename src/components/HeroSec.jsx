    ...
    return(
        <div className="main-div">
            ...
            <div className="main-linkings">
                <img src="./images/linkedin.png" alt="" className="img-link"/>
                <img src="./images/facebook.png" alt="" className="img-link"/>
                <img src="./images/gmail.png" alt="" className="img-link"/>
                <img src="./images/instagram.png" alt="" className="img-link"/>
            </div>
        </div>
    )
}